...
public class AdvancedReader {
  ...
  public static void main(Configuration conf, String[] args) throws IOException {
    ...
    Reader reader = OrcFile.createReader(new Path("advanced-example.orc"), OrcFile.readerOptions(conf));
    ...
    // 定义文件Schema信息
    TypeDescription readSchema = TypeDescription.fromString("struct<first:int,second:int,third:map<string,int>>");
