...
class ZeroCopyShims {
  ...
  private static final class ZeroCopyAdapter implements HadoopShims.ZeroCopyReaderShim {
    private final FSDataInputStream in;              // HDFS 数据读取句柄
    private final ByteBufferPoolAdapter pool;        // ByteBufferPool 的装饰器
    ...
    public ByteBuffer readBuffer(int maxLength, boolean verifyChecksums)
      ...
      // 通过 FSDataInputStream.read 拿到 NIO 操作句柄
